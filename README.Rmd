...
The General Social Survey Cumulative Data (1972-2024, release 2) and Panel Data files packaged for easy use in R. The companion package to `{gssr}` is [gssrdoc](https://kjhealy.github.io/gssrdoc), which integrates the GSS codebook into R's help system. I recommend you install both packages.
...
The [GSS Documentation Page](https://gss.norc.org/us/en/gss/get-documentation.html) contains links to extensive technical documentation for the survey, including [Release Notes for the 1972-2024 R2 Cumulative File](https://gss.norc.org/content/dam/gss/get-documentation/pdf/other/Release%20Notes%207224%20R2.pdf) and [What's New in 2024 R2](https://gss.norc.org/content/dam/gss/get-documentation/pdf/other/GSS%202024%20-%20Whats%20New%20R2.pdf).
