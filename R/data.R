...
#'
#' @format An object of class `tibble` with 75,699 rows and 6,904 columns. Variables are encoded as labelled vectors. The GSS Codebook is the authoritative source for the variables in this dataset. It is available at <http://gss.norc.org/Get-Documentation>.Integrated documentation is available from the `gssrdoc` package, available at <https://kjhealy.github.io/gssrdoc/>.
#'
#' @docType data
#' @usage data(gss_all)
#' @keywords datasets
